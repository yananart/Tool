...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        loadingPanel.add(label1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER,
    ...
    private Font $$$getFont$$$(String fontName, int style, int size, Font currentFont) {
        ...
        Font font =
                new Font(resultName, style >= 0 ? style : currentFont.getStyle(), size >= 0 ? size :
                        currentFont.getSize());
        boolean isMac = System.getProperty("os.name", "").toLowerCase(Locale.ENGLISH).startsWith("mac");
        Font fontWithFallback =
                isMac ? new Font(font.getFamily(), font.getStyle(), font.getSize()) :
